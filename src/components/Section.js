        ...
        <>
            ...
            <div className='py-8'>
                <div className='flex justify-center items-center'>
                    <div className='py-6'>
                        <h2 className='text-4xl text-center'>Subscribe to Our NewsLetter</h2>
                        <div className='py-6 w-4/5 mx-auto'>
                            <input placeholder='Enter Email' name='confirm_password' required type="text" className='py-2 w-full mx-auto px-4 md:w-full outline-none c-text-input' />
                        </div>
                        <div className='flex justify-center items-center'>
