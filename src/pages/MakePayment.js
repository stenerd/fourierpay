					...
					<div className="min-h-dvh">
						...
						<div className="relative mt-8 pt-6 w-full flex-1 border border-green-500 rounded-xl p-4 backdrop-blur-sm">
							...
							<button
								...
								className="mt-2 bg-green-900 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded-lg transition duration-200"
							>
								Become an Affiliate →
							</button>
						</div>
														...
														<div className="py-2">
															...
															<div className="relative mt-12 pt-6 w-full flex-1 border border-green-800  rounded-xl p-6 backdrop-blur-sm">
																...
																<button
																	type="button"
																	onClick={handleBecomeAffiliate}
																	className="mt-5 bg-green-700 hover:bg-green-900 text-white font-semibold py-3 px-6 rounded-lg transition duration-200"
																>
																	Become an Affiliate →
																</button>
															</div>
