            ...
            <DashboardLayout>
                ...
                <div className='px-16 py-8'>
                    {/* <div className='flex justify-between items-center w-[90%] mx-auto'>
                        ...
                        <button onClick={toggleDrawer("right", true)} className='px-4 py-2 rounded-md text-white bg-[#1d3329]'>Create Payment</button>
                    </div> */}
                    {/* <div className='py-6'>
                        <div className='flex items-center w-[90%] space-x-5 mx-auto'>
                            <div className='bg-[#F8FAF7] py-4 h-[200px] w-[200px] shadow-md'>
                                <div className='w-4/5 mx-auto py-2 space-y-4'>
                                    <IconButton>
                                        <WalletIcon className='text-[#1d3329]' fontSize='large' />
                                    </IconButton>
                            ...
                            <div className='bg-[#F8FAF7] py-4 h-[200px] shadow-md w-[200px]'>
                                <div className='w-4/5 mx-auto py-2 space-y-4'>
                                    <IconButton>
                                        <LinkIcon className='text-[#1d3329]' fontSize='large' />
                                    </IconButton>
                            ...
                            <div className='bg-[#F8FAF7] py-4 h-[200px] shadow-md w-[200px]'>
                                <div className='w-4/5 mx-auto py-2 space-y-4'>
                                    <IconButton>
                                        <CreditCardIcon className='text-[#1d3329]' fontSize='large' />
                                    </IconButton>
                        ...
                        <div className='py-6'>
                            <div className='w-[90%] mx-auto'>
                                ...
                                <div className='flex justify-between items-center space-between py-4 text-center font-mono font-bold'>
                                    ...
                                    <div>
                                        <button className='rounded-[50px] text-[#1d3329] bg-[#F8FAF7] py-2 px-4'><span></span> Success</button>
                                    </div>
                                </div>
                                <div className='flex justify-between items-center space-between py-4 text-center font-bold font-mono'>
                                    ...
                                    <div><h2 className=' flex-1'>12/10/2023</h2></div>
                                    <div>
                                        <button className='rounded-[50px] text-[#1d3329] bg-[#F8FAF7] py-2 font-bold px-4'><span></span> Success</button>
                                    </div>
                                </div>
